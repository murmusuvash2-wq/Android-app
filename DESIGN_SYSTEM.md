...
- **Restrained Accents:**
  - **Deep Forest (`#3F5147`)** is an intentional, selective accent for primary states, active selection, and AI features. It must **never** saturate entire backgrounds, large card containers, or dominant button clusters.
  - **Champagne Gold (`#C9A961`)** is used sparingly for premium badges, credit balances, and verified indicators. Never use garish amber or bright arcade orange.
...
| **Primary Accent** | `#3F5147` | Deep Forest | Brand accent, active tab pills, selected state indicators |
...
### Primary Accent (`#3F5147` - Deep Forest)
...
- **Semantic Mapping:**
  ...
  - `colorScheme.primary` $\rightarrow$ `#3F5147`
