...
object MockProductDataSource : ProductDataSource {
    ...
    val HERO_LOOKS: List<HeroLook> = listOf(
        HeroLook(
            id = "hero_1",
            productId = "1",
            hangerImage = "https://images.unsplash.com/photo-1572804013309-59a88b7e92f1?auto=format&fit=crop&w=800&q=80",
            wornImage = "https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?auto=format&fit=crop&w=800&q=80"
        ),
        HeroLook(
            id = "hero_2",
            productId = "3",
            hangerImage = "https://images.unsplash.com/photo-1509631179647-0177331693ae?auto=format&fit=crop&w=800&q=80",
            wornImage = "https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=800&q=80"
        )
    )
